...
const Dashboard = () => {
  ...
  // ? CORREÇÃO: Remove o redirecionamento automático
  // O redirecionamento já foi feito no Login.js
  // Se um prestador chegou aqui, é porque clicou no link errado
  ...
  // ? CORREÇÃO: Se for prestador, mostra mensagem de erro
