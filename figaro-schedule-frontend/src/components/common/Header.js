...
const Header = () => {
  ...
  // ? CORRE��O: Fun��o para determinar o link do dashboard
        ...
        <nav style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          {isAuthenticated ? (
            <>
              ...
              {/* ? CORRE��O: Link din�mico para dashboard */}
              <Link to={getDashboardLink()} style={navStyle}>
                Dashboard
              </Link>
              
              {/* ? NOVO: Link para Servi�os Dispon�veis (apenas clientes) */}
              {user?.type === 'cliente' && (
              ...
              {/* ? Link para Meus Servi�os (apenas prestadores) */}
              {user?.type === 'prestador' && (
